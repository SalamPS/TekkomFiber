...
const list = [
  ...
  new object('monitor', 'Asus PC Gaming Monitor', 'Gaming Monitor', 'display', 'tv-fill', {
    scale: 15,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, -5, 0],
  ...
  new object('motherboard', 'Asus Strix B550-F Gaming Motherboard', 'Gaming Motherboard', 'motherboard', 'motherboard-fill', {
    scale: 0.8,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, -13, 0],
  ...
  new object('ddr4', 'Crucial Ballistix 8GB DDR4 3600 RAM (Black)', 'DDR4 RAM', 'ram', 'memory', {
    scale: 200,
    speed: [0, 0, 0],
    light: 15,
    pos: [0, 0, 0],
  ...
  new object('cpu', 'Dream Computer CPU', 'Computer CPU', 'cpu', 'cpu-fill', {
    scale: 1,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, 0, 0],
  ...
  new object('ball', 'Gaming Mouse', 'Gaming Mouse', 'mouse', 'mouse3-fill', {
    scale: 1,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, 0, 0],
  ...
  new object('mechanical', 'Mechanical RGB Keyboard', 'RGB Keyboard', 'keyboard', 'keyboard-fill', {
    scale: 0.3,
    speed: [0.0005, 0, 0],
    light: undefined,
    pos: [0, 0, 0],
  ...
  new object('air', 'PC Cooler 2', 'Cooling System', 'cooling', 'fan', {
    scale: 1,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, 0, 0],
  ...
  new object('speaker', 'Speaker Vipe Nitro X7', 'Gaming Speaker', 'speaker', 'speaker-fill', {
    scale: 1,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, 0, 0],
  ...
  new object('ssd', 'SSD Samsung 980 Pro 1TB', 'Solid State Drive', 'storage', 'hdd-fill', {
    scale: 1,
    speed: [0, 0, 0],
    light: undefined,
    pos: [0, 0, 0],
